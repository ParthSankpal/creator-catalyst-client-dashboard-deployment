...
export default function Home() {
  return (
    <main className="h-screen w-screen flex flex-col relative overflow-hidden">
      ...
      <div className="mt-20 sm:mt-32 relative z-10 flex-1 flex items-center justify-center px-4 sm:px-6">
        <Link
          href="/login"
      ...
      {/* Footer */}
      <div className="relative z-0 w-full flex justify-center flex-shrink-0">
        <img
          src="/footer.png"
          className="w-full sm:w-[80%] block object-cover object-bottom opacity-50"
        />
      </div>
    </main>
  );
